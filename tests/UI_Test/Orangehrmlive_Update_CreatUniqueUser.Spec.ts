...
test('Orangehrmlive Update Create Unique User', async ({ page }) => {
  ...
  await page.locator("//div[text()='"+UserName+"']//parent::div/following-sibling::div/div/button/i[@class='oxd-icon bi-pencil-fill']").click();
  await page.pause()
